...
let email = "nicholas.hamakami@gmail.com";
let password = "default";

function get() {
    email = document.getElementById('emailSetup').value;
    password = document.getElementById('passwordSetup').value;
...
// let password = document.getElementById('passwordTest').value;
